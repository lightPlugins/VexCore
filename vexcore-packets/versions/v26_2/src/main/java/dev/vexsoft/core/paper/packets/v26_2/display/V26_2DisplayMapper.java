...
public class V26_2DisplayMapper {
    ...
    public static Transformation toNms(final DisplayTransformation transformation) {
        return new Transformation(
            ...
            new Vector3f(transformation.getScaleX(), transformation.getScaleY(), transformation.getScaleZ()),
            new Quaternionf(
    ...
    public static byte applyAlignment(final byte current, final TextDisplayAlignment alignment) {
        byte flags = (byte) (current & ~Display.TextDisplay.FLAG_ALIGN_LEFT & ~Display.TextDisplay.FLAG_ALIGN_RIGHT);
