...
/** Installs and removes the Minecraft 26.2 connection handlers used to intercept packets. */
@Dependencies
public final class VexPacketConnectionAdapterService implements PacketConnectionAdapterService {
    ...
    public void inject(final Player player, final PacketDuplexHandler handler) {
        ...
        channel.eventLoop().execute(() -> addHandler(channel.pipeline(), player.getUniqueId(), handler));
    }
