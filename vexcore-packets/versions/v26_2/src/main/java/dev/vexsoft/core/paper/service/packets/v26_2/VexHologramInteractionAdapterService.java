...
/** Decodes Minecraft 26.2 interaction packets into VexCore interaction input. */
@Dependencies
public final class VexHologramInteractionAdapterService implements HologramInteractionAdapterService {
    ...
    public Optional<PacketInteractionInput> decode(final Object packet) {
        ...
        if (packet instanceof ServerboundInteractPacket interactPacket) {
            EquipmentSlot hand =
                interactPacket.hand() == InteractionHand.OFF_HAND ? EquipmentSlot.OFF_HAND : EquipmentSlot.HAND;
