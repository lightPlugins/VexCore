...
public final class V26_2PlayerDummies {
    ...
    public void skin(Player viewer, FakeDisplayHandle handle, SkinTexture skin) {
        ...
        builder.addProperty(skin.signature() == null ? new ProfileProperty("textures", skin.value())
    ...
    public void armor(Player viewer, FakeDisplayHandle handle, ItemStack[] armor) {
        ...
        for (int slotIndex = 0; slotIndex < 4; slotIndex++) {
            items.add(Pair.of(slots[slotIndex], CraftItemStack.asNMSCopy(armor[slotIndex])));
        }

        transport.sendBundle(viewer, List.of(new ClientboundSetEquipmentPacket(handle.getEntityId(), items)));
    }
