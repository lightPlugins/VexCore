...
public interface DisplayPassengerPacketService extends VexService {
    ...
    default void setFakePassengers(
        ...
        setFakePassengersWithOffset(viewer, vehicle, passengers.stream().map(FakePassengerMount::of).toList());
    }
    ...
    default void setFakePassengers(
        ...
        setFakePassengersWithOffset(viewer, vehicleEntityId, passengers.stream().map(FakePassengerMount::of).toList());
    }

    /** Replaces the offset fake passengers mounted onto a real entity */
    void setFakePassengersWithOffset(Player viewer, Entity vehicle, List<FakePassengerMount> passengers);

    /** Replaces the offset fake passengers mounted onto an entity id */
    void setFakePassengersWithOffset(Player viewer, int vehicleEntityId, List<FakePassengerMount> passengers);

    /** Adds one fake passenger to a real entity */
    default void addFakePassenger(final Player viewer, final Entity vehicle, final FakeDisplayHandle passenger) {
        addFakePassenger(viewer, vehicle, FakePassengerMount.of(passenger));
    }

    /** Adds one fake passenger to an entity id */
    default void addFakePassenger(final Player viewer, final int vehicleEntityId, final FakeDisplayHandle passenger) {
