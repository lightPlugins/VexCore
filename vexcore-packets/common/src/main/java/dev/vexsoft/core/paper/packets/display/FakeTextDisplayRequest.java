...
public final class FakeTextDisplayRequest {
    ...
    public static FakeTextDisplayRequestBuilder builder(final Location location, final Component text) {
    ...
    private static Set<DisplayLifecycle> copyLifecycle(final Set<DisplayLifecycle> lifecycle) {
        ...
        return checked.isEmpty() ? Set.of() : Set.copyOf(EnumSet.copyOf(checked));
    }
}
