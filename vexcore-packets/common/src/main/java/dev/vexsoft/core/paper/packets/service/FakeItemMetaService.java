...
public interface FakeItemMetaService extends VexService {
    ...
    void setLore(NamespacedKey itemIdKey, String itemId, List<Component> lore, FakeItemLoreMode mode);
    ...
    void setLore(Player viewer, NamespacedKey itemIdKey, String itemId, List<Component> lore, FakeItemLoreMode mode);
    ...
    void setDisplayName(Player viewer, NamespacedKey itemIdKey, String itemId, Component displayName);
    ...
    void setItemModel(Player viewer, NamespacedKey itemIdKey, String itemId, NamespacedKey itemModel);
