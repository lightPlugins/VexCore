...
final class FakeBlockDamageOverlayRequestTest {
    ...
    void acceptsHiddenAndVisibleDamageStages() {
        FakeBlockDamageOverlayRequest hidden =
            FakeBlockDamageOverlayRequest.builder(location(), new NamespacedKey("test", "damage/crack")).build();
        FakeBlockDamageOverlayRequest cracked =
            FakeBlockDamageOverlayRequest.builder(location(), new NamespacedKey("test", "damage/crack"))
                .damageStage(9)
                .build();
    ...
    void rejectsDamageStagesOutsideTheProtocolRange() {
        ...
        assertThrows(IllegalArgumentException.class, () -> FakeBlockDamageOverlayUpdate.stage(-2));
    }
