...
public final class VexBlockDamageOverlayPacketService implements BlockDamageOverlayPacketService, AutoCloseable {
    ...
    public VexBlockDamageOverlayPacketService(final VexServiceRegistry services) {
        itemDisplays = Objects.requireNonNull(services, "services").require(ItemDisplayPacketService.class);
    }

    @Override
    public FakeDisplayHandle spawn(final Player viewer, final FakeBlockDamageOverlayRequest request) {
    ...
    @Override
    public void update(final FakeDisplayHandle handle, final FakeBlockDamageOverlayUpdate update) {
        ...
        FakeItemDisplayUpdate.FakeItemDisplayUpdateBuilder builder = FakeItemDisplayUpdate.builder()
    ...
    private static ItemStack overlayItem(final NamespacedKey modelPrefix, final int damageStage) {
        ...
        NamespacedKey model = new NamespacedKey(modelPrefix.getNamespace(), modelPrefix.getKey() + "_" + damageStage);
