...
@Dependencies({PlayerDataCoordinatorService.class, PlayerDataStoreService.class, PlayerIdentityService.class, SignalService.class, StatContributionCoordinatorService.class})
public final class VexPlayerLifecycleListener implements Listener {
    ...
    public void onPlayerPreLogin(final AsyncPlayerPreLoginEvent event) {
        ...
        try {
            ...
            CompletableFuture.runAsync(
                ...
                CompletableFuture.delayedExecutor(dataStore.getLoginTimeout().toMillis(), TimeUnit.MILLISECONDS)
            );
            ...
            event.disallow(AsyncPlayerPreLoginEvent.Result.KICK_OTHER, Component.text(dataStore.getLoginKickMessage()));
        }
    }
    ...
    public void onPlayerJoin(final PlayerJoinEvent event) {
        ...
        VexPlayer player = players.find(uniqueId)
