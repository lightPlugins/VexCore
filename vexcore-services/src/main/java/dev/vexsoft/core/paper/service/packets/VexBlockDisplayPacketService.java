...
public final class VexBlockDisplayPacketService implements BlockDisplayPacketService, AutoCloseable {
    ...
    @Override
    public FakeDisplayHandle spawn(final Player viewer, final FakeBlockDisplayRequest request) {
