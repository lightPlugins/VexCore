...
public final class VexPaperPlaceholderService implements PlaceholderService, AutoCloseable {
    ...
    public Component resolve(final VexPlayer player, final Component component) {
        Component resolved = PlaceholderComponents.resolve(this, player, component);
        ...
        return resolved.replaceText(TextReplacementConfig.builder().match(TOKEN).replacement((match, builder) -> {
