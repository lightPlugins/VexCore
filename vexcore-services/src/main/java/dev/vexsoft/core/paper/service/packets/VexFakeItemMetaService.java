...
/** Registers this owner's fake item metadata rules and refreshes affected player inventories. */
...
public final class VexFakeItemMetaService implements FakeItemMetaService, AutoCloseable {
    ...
    @Override
    public void setDisplayName(final NamespacedKey itemIdKey, final String itemId, final Component displayName) {
    ...
    public void setDisplayName(
        ...
        update(viewer.getUniqueId(), itemIdKey, itemId, rule -> rule.toBuilder().displayName(displayName).build());
    }

    @Override
    public void setItemModel(final NamespacedKey itemIdKey, final String itemId, final NamespacedKey itemModel) {
    ...
    public void setItemModel(
        ...
        update(viewer.getUniqueId(), itemIdKey, itemId, rule -> rule.toBuilder().itemModel(itemModel).build());
    }
    ...
    @Override
    public void clearLore(final Player viewer, final NamespacedKey itemIdKey, final String itemId) {
    ...
    @Override
    public void clearDisplayName(final Player viewer, final NamespacedKey itemIdKey, final String itemId) {
    ...
    @Override
    public void clearItemModel(final Player viewer, final NamespacedKey itemIdKey, final String itemId) {
    ...
    private void lore(
        ...
        update(viewerId, itemIdKey, itemId, rule -> rule.toBuilder().lore(List.copyOf(lore)).loreMode(mode).build());
    }

    private void clearLore(final UUID viewerId, final NamespacedKey itemIdKey, final String itemId) {
        update(viewerId, itemIdKey, itemId, rule -> rule.toBuilder().lore(null).loreMode(null).build());
    }

    private void clearDisplayName(final UUID viewerId, final NamespacedKey itemIdKey, final String itemId) {
        update(viewerId, itemIdKey, itemId, rule -> rule.toBuilder().displayName(null).build());
    }

    private void clearItemModel(final UUID viewerId, final NamespacedKey itemIdKey, final String itemId) {
        update(viewerId, itemIdKey, itemId, rule -> rule.toBuilder().itemModel(null).build());
    }
