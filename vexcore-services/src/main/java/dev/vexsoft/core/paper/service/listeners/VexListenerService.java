...
/** Creates and registers Bukkit listeners for the current plugin and removes them during cleanup. */
@Dependencies
public final class VexListenerService implements ListenerService, AutoCloseable {
    ...
    private <T extends Listener> T instantiate(final Class<T> listenerType, final VexServiceRegistry serviceScope) {
