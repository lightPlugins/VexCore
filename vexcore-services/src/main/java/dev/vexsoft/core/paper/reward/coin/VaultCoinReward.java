...
public final class VaultCoinReward implements Reward {
    ...
    private record Compiled(CompiledExpression amount, EconomyService economy) implements CompiledReward {
        ...
        public List<ExecutionDescription> describeEntries(final PlayerExecutionContext context) {
            ...
            return List.of(new ExecutionDescription("", Map.of("amount", Component.text(formatted)), fallback));
        }
