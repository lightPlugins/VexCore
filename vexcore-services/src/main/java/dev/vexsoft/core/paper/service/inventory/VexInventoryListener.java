...
public final class VexInventoryListener implements Listener {
    ...
    public VexInventoryListener(final VexServiceRegistry services) {
        InventoryService service = Objects.requireNonNull(services, "services").require(InventoryService.class);
    ...
    public void onDrag(final InventoryDragEvent event) {
        ...
        if (!(event.getWhoClicked() instanceof Player player) || !holder.getViewerId().equals(player.getUniqueId())) {
            event.setCancelled(true);
