...
public final class VaultCoinRequirement implements Requirement {
    ...
    private record Compiled(CompiledExpression amount, EconomyService economy) implements CompiledRequirement {
        ...
        public RequirementResult test(final PlayerExecutionContext context) {
            ...
            return current >= required ? RequirementResult.success()
        ...
        public Component describe(final PlayerExecutionContext context) {
            ...
            return Component.text(satisfied ? "✔ " : "✘ ", satisfied ? NamedTextColor.GREEN : NamedTextColor.RED)
        ...
        public List<ExecutionDescription> describeEntries(final PlayerExecutionContext context) {
            ...
            return List.of(new ExecutionDescription(
                ...
                Map.of("amount", Component.text(economy.format(required)), "state_symbol", symbol(satisfied)),
                describe(context)
            ));
        }
