...
@Builder
public record UiBoxLayout(ScreenAnchor anchor, int x, int y, int height, int padding, int lineSpacing,
                          HorizontalAlignment alignment, TextColor tint, boolean background, int layer,
