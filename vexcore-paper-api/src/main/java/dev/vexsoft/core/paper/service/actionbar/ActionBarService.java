...
public interface ActionBarService extends VexService {
    ...
    default void setPersistent(final Player player, final String channel, final Component component) {
    ...
    void showTemporary(Player player, String channel, Component component, long durationTicks, int priority);
