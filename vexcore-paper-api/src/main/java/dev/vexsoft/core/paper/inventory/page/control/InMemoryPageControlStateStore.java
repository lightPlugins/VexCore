...
public final class InMemoryPageControlStateStore implements PageControlStateStore {
    ...
    public void setActiveMode(
        ...
        states.put(new StateKey(viewerId, inventoryKey, areaId, controlId), Objects.requireNonNull(modeId, "modeId"));
    }
    ...
    private record StateKey(UUID viewerId, InventoryKey inventoryKey, String areaId, String controlId) {
