...
public class BackInventoryElement extends AbstractInventoryElement {
    ...
    public BackInventoryElement(final int steps) {
        this(createDefaultItem(), context -> context.getInventoryService().back(context.getViewer(), steps));
    ...
    protected BackInventoryElement(final ItemStack item, final Consumer<InventoryContext> action) {
