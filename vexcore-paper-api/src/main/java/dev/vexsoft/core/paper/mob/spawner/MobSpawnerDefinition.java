...
public final class MobSpawnerDefinition {
    ...
    private MobSpawnerDefinition(final Builder builder) {
        ...
        if (builder.maximumAlive < 1 || builder.spawnBatchSize < 1 || builder.spawnBatchSize > builder.maximumAlive
            || builder.spawnIntervalTicks < 1L) {
    ...
    public static Builder builder(final MobSpawnerKey key, final MobKey mobKey, final Location anchor) {
    ...
    public boolean equals(final Object other) {
        ...
        return key.equals(definition.key) && mobKey.equals(definition.mobKey) && anchor.equals(definition.anchor)
            && scope == definition.scope && Double.compare(activationRadius, definition.activationRadius) == 0
            && Double.compare(deactivationRadius, definition.deactivationRadius) == 0
            && maximumAlive == definition.maximumAlive && spawnBatchSize == definition.spawnBatchSize
            && spawnIntervalTicks == definition.spawnIntervalTicks
            && exactSpawnPosition == definition.exactSpawnPosition && positionRules.equals(definition.positionRules);
    }
    ...
    public static final class Builder {
        ...
        private Builder(final MobSpawnerKey key, final MobKey mobKey, final Location anchor) {
