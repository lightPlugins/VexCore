...
public record MobSpawnRequest(MobKey definitionKey, Location location, MobScope scope, Location movementOrigin) {
    ...
    public MobSpawnRequest(final MobKey definitionKey, final Location location, final MobScope scope) {
