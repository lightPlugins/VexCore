...
import dev.vexsoft.core.paper.inventory.element.BackInventoryElement;
...
public abstract class AbstractInventoryView implements InventoryView {
    ...
    protected AbstractInventoryView(final VexServiceRegistry services, final InventoryKey key, final int size) {
