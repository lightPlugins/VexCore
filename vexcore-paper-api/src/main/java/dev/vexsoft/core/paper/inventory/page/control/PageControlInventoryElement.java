...
import dev.vexsoft.core.paper.inventory.element.AbstractInventoryElement;
...
public final class PageControlInventoryElement extends AbstractInventoryElement {
    ...
    public ItemStack render(final InventoryContext context) {
        String mode =
            states.getActiveMode(context.getViewer().getUniqueId(), inventoryKey, areaId, control.getControlId())
    ...
    public void onClick(final InventoryContext context, final InventoryClickEvent event) {
        if (event.getClick() == ClickType.RIGHT) {
            states.cyclePrevious(context.getViewer().getUniqueId(), inventoryKey, areaId, control);
        } else {
            states.cycleNext(context.getViewer().getUniqueId(), inventoryKey, areaId, control);
        }
