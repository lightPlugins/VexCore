...
public final class MobHologramDefinition {
    ...
    public static MobHologramDefinition automatic(final float padding, final MobHologramRenderer renderer) {
        return builder(padding, true, renderer).build();
    }

    /** Creates a fixed-offset hologram with default display settings. */
    public static MobHologramDefinition fixed(final float offsetY, final MobHologramRenderer renderer) {
    ...
    public static final class Builder {
        ...
        private Builder(final float offsetY, final boolean automaticOffset, final MobHologramRenderer renderer) {
