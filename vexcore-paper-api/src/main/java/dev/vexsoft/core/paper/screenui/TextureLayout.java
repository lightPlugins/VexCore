...
@Builder
public record TextureLayout(int x, int y, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignment,
                            int layer, ScreenAnchor anchor, TextColor tint, UiAnimation animation, boolean compact,
                            double scale) {
