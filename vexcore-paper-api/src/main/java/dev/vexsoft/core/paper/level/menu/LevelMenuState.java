...
public enum LevelMenuState {
    CLAIMED, CLAIMABLE, REQUIREMENTS_NOT_MET, COSTS_NOT_AFFORDABLE, LOCKED;

    /** Resolves a displayed level against the live preview of the next sequential claim. */
    public static LevelMenuState resolve(final int displayedLevel, final LevelClaimPreview nextClaim) {
