...
public record MeleeLeapDefinition(boolean enabled, double minDistance, int cooldownTicks,
    ...
    public MeleeLeapDefinition(boolean enabled, double minDistance, int cooldownTicks,
        double horizontalSpeed, double maxHorizontalSpeed, double verticalSpeed) {
        this(enabled, minDistance, cooldownTicks, horizontalSpeed, maxHorizontalSpeed, verticalSpeed,
            false, 1.2, 1.4, 1.5);
    }

    public static final MeleeLeapDefinition DISABLED = new MeleeLeapDefinition(false, 6, 60, 0.8, 1.3, 0.45);

    /** Validates finite speeds, a positive trigger distance, and cooldown. */
    public MeleeLeapDefinition {
