...
public record LevelMenuSettings(int inventorySize, PageBounds bounds, Map<LevelMenuState, Key> stateModels) {

    /** Exact default visual sequence for level 1 through level 16. */
    public static final List<Integer> DEFAULT_SNAKE_SLOTS =
        List.of(10, 19, 28, 29, 30, 21, 12, 13, 14, 23, 32, 33, 34, 25, 16, 17);
