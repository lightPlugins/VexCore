...
public interface CommandArgumentType<T> extends CustomArgumentType.Converted<T, String> {
    ...
    default T read(final CommandContext<CommandSourceStack> context, final String name) {
    ...
    default void suggest(final VexCommandSource source, final String input, final Consumer<String> suggestion) {
    }
}
