...
public interface ScheduleService extends VexService {
     ...
     * @return cancellable repeating-task handle
     */
    VexTask runAtTimer(Location location, long initialDelayTicks, long periodTicks, Runnable task);
     ...
     * @return task handle, or empty if the entity has already retired
     */
    Optional<VexTask> runForLater(Entity entity, long delayTicks, Runnable task, Runnable retired);
