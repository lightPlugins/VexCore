...
public record MobSpawnPositionRules(
  ...
  public MobSpawnPositionRules {
    if (!Double.isFinite(minimumRadius) || minimumRadius < 0.0D
        || !Double.isFinite(maximumRadius) || maximumRadius < minimumRadius) {
