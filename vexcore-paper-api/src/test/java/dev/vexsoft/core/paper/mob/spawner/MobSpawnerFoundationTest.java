...
class MobSpawnerFoundationTest {
    ...
    void keepsSpawnAndMovementOriginsIndependentAndDefensive() {
        ...
        MobSpawnRequest request =
            new MobSpawnRequest(MobKey.of("arcane_monolith", "chicken"), spawn, MobScope.global(), anchor);
