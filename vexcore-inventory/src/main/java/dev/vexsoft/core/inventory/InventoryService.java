...
public interface InventoryService extends VexService {
  ...
  public void register(Class<? extends InventoryDefinition> definitionType);

  /** Returns every inventory key registered by the current plugin */
  public Collection<InventoryKey> getKeys();

  /** Opens a registered inventory and adds the current view to history */
  public void open(Player player, InventoryKey key);

  /** Opens a view and adds the current view to history */
  public void open(Player player, InventoryView view);

  /** Replaces the current view without changing its history */
  public void replace(Player player, InventoryKey key);

  /** Replaces the current view without changing its history */
  public void replace(Player player, InventoryView view);
