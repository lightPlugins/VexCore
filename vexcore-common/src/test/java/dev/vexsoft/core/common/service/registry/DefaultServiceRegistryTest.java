...
class DefaultServiceRegistryTest {
    ...
    void createsServicesInDependencyOrder() {
        ...
        assertSame(services.require(TestService.class), services.require(DependentService.class).getDependency());
    }
    ...
    void queuedLocalDependencyWinsWhenOtherScopesAlreadyProvideIt() {
        ...
        assertSame(essentials.require(TestService.class), essentials.require(DependentService.class).getDependency());
    }
    ...
    void createsRegistryAwareComponentsFromClasses() {
        ...
        RegistryAwareComponent component = VexClassFactory.create(RegistryAwareComponent.class, services, "Component");
