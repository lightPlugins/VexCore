...
final class VexCompiledLevelCurveTest {
    ...
    void calculatesBoundariesAndMaximumProgress() {
        VexCompiledLevelCurve curve = new VexCompiledLevelCurve(0, 3, new double[]{0.0D, 100.0D, 250.0D, 450.0D});
    ...
    void rejectsInvalidExperienceAndUnsupportedThresholds() {
        VexCompiledLevelCurve curve = new VexCompiledLevelCurve(0, 1, new double[]{0.0D, 100.0D});
