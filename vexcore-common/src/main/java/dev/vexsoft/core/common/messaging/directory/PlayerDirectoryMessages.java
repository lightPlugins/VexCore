...
public final class PlayerDirectoryMessages {
    ...
    public static final MessageType<PlayerDirectoryRequest> REQUEST =
        MessageType.json(MessageKey.of("vexcore", "directory.player_request"), PlayerDirectoryRequest.class);
    public static final MessageType<PlayerDirectoryResponse> RESPONSE =
        MessageType.json(MessageKey.of("vexcore", "directory.player_response"), PlayerDirectoryResponse.class);
    public static final MessageType<PlayerDirectoryListRequest> LIST_REQUEST =
