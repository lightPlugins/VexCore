...
public final class VexStatContributionRegistry implements StatContributionRegistry, AutoCloseable {
    ...
    @Override
    public void register(final String key, final Class<? extends StatContributionProvider> providerType) {
