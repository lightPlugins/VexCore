...
public final class VexLocalizedMessageService implements LocalizedMessageService {
    ...
    public void send(
        ...
        LanguageKey language = checkedPlayer.getContainer(LanguageContainer.class).getLanguage().getKey();
        ...
        Component prefix = withPrefix ? placeholders.resolve(
            checkedPlayer,
    ...
    public void send(
        ...
        Component prefix = withPrefix ? localization.resolve(checkedLanguage, prefixKey, Map.of()).getLines().getFirst()
            : Component.empty();
