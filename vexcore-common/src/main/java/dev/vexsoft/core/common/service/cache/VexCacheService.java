...
import dev.vexsoft.core.common.cache.VexCaffeineFactory;
...
/** Creates and tracks named caches for one service owner and clears them during cleanup. */
@Dependencies
public final class VexCacheService implements CacheService, AutoCloseable {
    ...
    @Override
    public <K, V> VexCache<K, V> create(final String name, final VexCacheOptions options) {
    ...
    public <K, V> VexAsyncCache<K, V> createAsync(
        ...
        VexLocalAsyncCache<K, V> created =
            new VexLocalAsyncCache<>(checkedName, cache, Objects.requireNonNull(loader, "loader"));
