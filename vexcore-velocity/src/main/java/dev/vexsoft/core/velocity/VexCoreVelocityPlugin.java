...
@Plugin(id = "vexcore", name = "VexCore", version = "1.0.0-SNAPSHOT", description = "Modular infrastructure for VexSoft Velocity plugins")
public final class VexCoreVelocityPlugin implements VexVelocityCore, ConfigurationOwner {
    ...
    public void onProxyInitialize(final ProxyInitializeEvent event) {
        ...
        try {
            ...
            coreServices.register(MessageTransportService.class, VexVelocityMessageTransportService.class);
            ...
            coreServices.register(ProxyPluginBootstrapService.class, VexProxyPluginBootstrapService.class);
            coreServices.registerQueuedServices();
            ...
            coreServices.require(MessagingService.class).register(VexPlayerDirectoryRequestHandler.class);
            coreServices.require(MessagingService.class).register(VexPlayerDirectoryListRequestHandler.class);
            ...
            platformLogger.info(
                "[VexCore] Shared storage initialized using " + (storageType.equals("postgresql") ? "PostgreSQL"
                    : storageType));
