...
public final class ComponentLines {
    ...
    private static void append(final Component component, final Style inheritedStyle, final List<Component> lines) {
        Style style = component.style().merge(inheritedStyle, Style.Merge.Strategy.IF_ABSENT_ON_TARGET);
