...
public record LevelDefinition(int minimumLevel, int maximumLevel, String requiredExperience, LevelClaimMode claimMode,
                              ClaimedLevelOverflowPolicy overflowPolicy, List<LevelRuleDefinition> rules) {
