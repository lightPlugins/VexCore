...
public record CompiledLevelDefinition(CompiledLevelCurve curve, LevelClaimMode claimMode,
                                      ClaimedLevelOverflowPolicy overflowPolicy, List<CompiledLevelRule> rules) {
