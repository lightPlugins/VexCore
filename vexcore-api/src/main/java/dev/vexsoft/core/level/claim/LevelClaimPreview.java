...
public record LevelClaimPreview(int level, LevelState state, LevelClaimStatus status,
                                RequirementExecutionResult requirements, CostExecutionResult costs,
                                List<Component> rewardLines, List<Component> costLines,
                                List<Component> requirementLines, List<TypedExecutionDescription> rewards,
