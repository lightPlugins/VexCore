...
public record TypedExecutionDescription(String type, String state, Map<String, Component> placeholders,
                                        Component fallback) {

    /** Creates a typed description from a compiled entry's description. */
    public static TypedExecutionDescription of(final String type, final ExecutionDescription description) {
