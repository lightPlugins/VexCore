...
public final class VexCoreResetCommand {
    ...
    @Command(value = "reset player <player> container <container> confirm", permission = "vexcore.command.reset.player.container")
    ...
    @Command(value = "reset player <player> all confirm", permission = "vexcore.command.reset.player.all")
    public int resetPlayerAll(final VexCommandSource source, @Argument("player") final String player) {
        return resetPlayer(
            source,
            player,
    ...
    @Command(value = "reset global container <container> confirm", permission = "vexcore.command.reset.global.container")
    ...
    @Command(value = "reset global all confirm", permission = "vexcore.command.reset.global.all")
    public int resetGlobalAll(final VexCommandSource source) {
        run(source, players.resetGlobalContainers(), "commands.vexcore.reset.global-all.success", Map.of());
