...
public final class GroundPositionSafety {
  ...
  public static boolean isSafe(
    ...
    if (!supportType.isSolid() || deniedSupportBlocks.contains(supportType)
        || (!allowedSupportBlocks.isEmpty() && !allowedSupportBlocks.contains(supportType))
        || avoidHazards && HAZARDS.contains(supportType)) {
      return false;
    }
